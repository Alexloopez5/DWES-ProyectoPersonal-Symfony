 ...
 */
final class Version20231027073654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto ADD file VARCHAR(255) NOT NULL, CHANGE proveedor_id proveedor_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE producto DROP file, CHANGE proveedor_id proveedor_id INT DEFAULT NULL');
    }
}
